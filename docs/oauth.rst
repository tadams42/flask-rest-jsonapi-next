...
flask-rest-jsonapi-next support OAuth via `Flask-OAuthlib <https://github.com/lepture/flask-oauthlib>`_
...
In this example flask-rest-jsonapi-next will protect all your resource methods with this decorator ::
